...
Finally, one of the best approach is to merge everything. `dplyr::full_join()` is a mutating join function that merge 2 data frame without any rows lost from either one. 
